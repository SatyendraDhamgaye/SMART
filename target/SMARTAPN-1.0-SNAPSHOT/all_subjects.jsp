                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">All Subjects List</div>
                                </div>
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li class="active">All Subjects List</li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                                            <div class="blogThumb">
                                                ...
                                                <div class="course-box">
                                                    <h4><%= rs.getString("sub_name")%></h4>
                                                    <div class="text-muted"><span class="m-r-10"><%= rs.getString("sub_code")%></span>
                                                        <a class="course-likes m-l-10" href="#"><i
                                                                class="fa fa-heart-o"></i> 654</a>
                                                    </div>
                                                    <p><span><i class="ti-alarm-clock"></i> <%= rs.getString("sub_teacher")%></span></p>
                                                    <p><span><i class="fa fa-graduation-cap"></i><%= rs.getString("scheme")%></span></p>
                                                                                <a href="edit_subject.jsp?id=<%= rs.getInt("id") %>">EDIT</a>
                                                                                <a href="SubjectController?action=delete&id=<%= rs.getInt("id")%>">DELETE</a>
