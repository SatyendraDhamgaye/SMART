					...
					<div class="row">
						...
						<div class="col-lg-6 p-t-20">
							<div class="wrap-input100 validate-input" data-validate="Enter username">
								<input class="input100" type="text" name="txtuername" placeholder="Username">
						...
						<div class="col-lg-6 p-t-20">
							...
							<div class="wrap-input100 validate-input" data-validate="Enter Enrollment">
								<input class="input100" type="text" name="txtLoginId" placeholder="Enrollment">
								<span class="focus-input100" data-placeholder="&#xf207;"></span>
							</div>
						</div>
					</div>
