							...
							<div class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                                                    <input class="mdl-textfield__input" type="text" name="txtJoiningDate" id="date" value="<%= rs.getString("joiningdate")%>">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                                                    <input class="mdl-textfield__input" type="password" name="txtPassword" value="<%= rs.getString("password")%>">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                                                    <input class="mdl-textfield__input" type="password" name="txtCPassword" value="<%= rs.getString("c_password")%>">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                                                    <input class="mdl-textfield__input" type="text" name="txtdesignation" value="<%= rs.getString("designation")%>">
											<label class="mdl-textfield__label">Designation</label>
                                                                    ...
                                                                    <div class="col-lg-6 p-t-20">
                                                                        <div
                                                                            ...
                                                                            <input class="mdl-textfield__input" type="text" name="txtDepartment" id="list2" value="<%= rs.getString("department")%>">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                                                                    <input class="mdl-textfield__input" type="text" name="txtGender" id="sample2" value="<%= rs.getString("gender")%>">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text"
                                                                                               pattern="-?[0-9]*(\.[0-9]+)?" name="txtMobileNo" value="<%= rs.getInt("mobile_no")%>">
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
                                                                                    <input type="textarea" class="mdl-textfield__input" rows="2" name="txtEducation" value="<%= rs.getString("education")%>">
